...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/newtestrunner3.o ${TESTDIR}/tests/testclass.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/tests/testclass.o: tests/testclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testclass.o tests/testclass.cpp
